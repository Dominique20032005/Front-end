  ...
  return (
    <>
      ...
      <div className='board w-full h-screen flex items-center justify-center flex-col'>
        ...
        <div className="stat w-fit flex justify-evenly">
          <div className='stats flex items-center justify-center flex-col'>
            <h2>2</h2>
            <p>Creators</p>
          </div>
          <div className='stats flex items-center justify-center flex-col'>
        ...
        <div className="creator w-fit flex items-center justify-evenly">
          <div className="person flex items-center justify-center flex-col">
